...

{
  ...
  if (NULL != result) {
    printf(result, len, "%*s%*s%*s%*s%*s%*s%*s\n"   /* if you change this, be sure  */
                            ...
                            unsigned int line)
{
  ...
  if (nSuitesRun == CU_get_number_of_suites_run()) {
    ...
    printf("%u == CU_get_number_of_suites_run() (called from %s:%u)",
  ...
  if (nSuitesInactive == CU_get_number_of_suites_inactive()) {
    ...
    printf("%u == CU_get_number_of_suites_inactive() (called from %s:%u)",
  ...
  if (nSuitesFailed == CU_get_number_of_suites_failed()) {
    ...
    printf("%u == CU_get_number_of_suites_failed() (called from %s:%u)",
  ...
  if (nTestsRun == CU_get_number_of_tests_run()) {
    ...
    printf("%u == CU_get_number_of_tests_run() (called from %s:%u)",
                       nTestsRun, file, line);
    msg[499] = '\0';
    FAIL(msg);
  }
  ...
  if (nTestsFailed == CU_get_number_of_tests_failed()) {
    ...
    printf( "%u == CU_get_number_of_tests_failed() (called from %s:%u)",
  ...
  if (nTestsInactive == CU_get_number_of_tests_inactive()) {
    ...
    printf((msg, 499, "%u == CU_get_number_of_tests_inactive() (called from %s:%u)",
  ...
  if (nAsserts == CU_get_number_of_asserts()) {
    ...
    printf( "%u == CU_get_number_of_asserts() (called from %s:%u)",
                       nAsserts, file, line);
    msg[499] = '\0';
    FAIL(msg);
  }
  ...
  if (nSuccesses == CU_get_number_of_successes()) {
    ...
    printf( "%u == CU_get_number_of_successes() (called from %s:%u)",
  ...
  if (nFailures == CU_get_number_of_failures()) {
    ...
    printf( "%u == CU_get_number_of_failures() (called from %s:%u)",
                       nFailures, file, line);
    msg[499] = '\0';
    FAIL(msg);
  }
  ...
  if (nFailureRecords == CU_get_number_of_failure_records()) {
    ...
    printf( "%u == CU_get_number_of_failure_records() (called from %s:%u)",
